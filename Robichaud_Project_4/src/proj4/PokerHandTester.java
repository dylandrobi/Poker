...
public class PokerHandTester {
    ...
    private static void testStringMethod() {
        String msg = "test the toString method for a hand of cards: face cards and non-face cards of all suits";
        ...
        String actual = "" + myHand;
        Testing.assertEquals(msg, expected, actual);
    }

    private static void testAddCardWhenFullHand() {
        String msg = "test the addCard method for a hand of cards when it's already full --- does nothing";
        Card myCard1 = new Card(5, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Hearts");
        Card myCard4 = new Card(13, "Spades");
        ...
        myHand.addCard(myCard6);
        Card expectedCardAdded = null;
        Card actualCardAdded = myHand.get_ith_card(5);
        Testing.assertEquals(msg, expectedCardAdded, actualCardAdded);
    }

    private static void testAddCardWhenHandNotFull() {
        String msg = "test the addCard method for a hand of cards when it has 4 out of 5 cards";
        ArrayList<Card> createHand = new ArrayList<>(5);
        Card myCard1 = new Card(5, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Hearts");
    ...
    private static void testGetithCardAt0Index() {
        String msg = "test the getNthCard() method at the 0th index of the hand";
        Card myCard1 = new Card(5, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Hearts");
        Card myCard4 = new Card(13, "Spades");
        Card myCard5 = new Card(2, "Diamonds");
        PokerHand myHand = helperToMakeHand(myCard1, myCard2, myCard3, myCard4, myCard5);
        Card cardAt0Index = myHand.get_ith_card(0);
    ...
    private static void testGetithCardAt1Index() {
        String msg = "test the getNthCard() method at the 1st index of the hand";
        Card myCard1 = new Card(5, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Hearts");
        Card myCard4 = new Card(13, "Spades");
        Card myCard5 = new Card(2, "Diamonds");
        PokerHand myHand = helperToMakeHand(myCard1, myCard2, myCard3, myCard4, myCard5);
        Card cardAt1Index = myHand.get_ith_card(1);
    ...
    private static void testGetithCardAt2Index() {
        String msg = "test the getNthCard() method at the 2nd index of the hand";
        Card myCard1 = new Card(5, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Hearts");
        Card myCard4 = new Card(13, "Spades");
        Card myCard5 = new Card(2, "Diamonds");
        PokerHand myHand = helperToMakeHand(myCard1, myCard2, myCard3, myCard4, myCard5);
        Card cardAt2Index = myHand.get_ith_card(2);
    ...
    private static void testGetithCardAt3Index() {
        String msg = "test the getNthCard() method at the 3rd index of the hand";
        Card myCard1 = new Card(5, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Hearts");
        Card myCard4 = new Card(13, "Spades");
        Card myCard5 = new Card(2, "Diamonds");
        PokerHand myHand = helperToMakeHand(myCard1, myCard2, myCard3, myCard4, myCard5);
        Card cardAt3Index = myHand.get_ith_card(3);
    ...
    private static void testGetithCardAt4Index() {
        ...
        Card myCard5 = new Card(2, "Diamonds");
        PokerHand myHand = helperToMakeHand(myCard1, myCard2, myCard3, myCard4, myCard5);
        Card cardAt4Index = myHand.get_ith_card(4);
    ...
    private static void testGetithCardAt5Index() {
        String msg = "test the getNthCard() method at the 5th index of the hand --- out of range of hand";
        Card myCard1 = new Card(5, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Hearts");
        Card myCard4 = new Card(13, "Spades");
        Card myCard5 = new Card(2, "Diamonds");
        PokerHand myHand = helperToMakeHand(myCard1, myCard2, myCard3, myCard4, myCard5);
        Card actualCardAt5Index = myHand.get_ith_card(5);
    ...
    private static void testHandTypeFlush() {
        String msg = "test the checkHand() method for a hand of type flush";
        Card myCard1 = new Card(5, "Clubs");
        ...
        for (int cardIndex = 0; cardIndex <= 5 - 1; cardIndex++) {
            Card myCard = myHand.get_ith_card(cardIndex);
        ...
        int expected = 4;
        int actual = myHand.checkHand(sortedRanks, suitsList);
        Testing.assertEquals(msg, expected, actual);
    }

    private static void testHandTypeTwoPair() {
        String msg = "test the checkHand() method for a hand of type two pair";
    ...
    private static void testHandTypePair() {
        String msg = "test the checkHand() method for a hand of type pair";
        Card myCard1 = new Card(14, "Clubs");
        Card myCard2 = new Card(14, "Diamonds");
        Card myCard3 = new Card(11, "Clubs");
